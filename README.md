...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:36BCF7,100:7F00FF&height=180&section=header&text=nahyunni&fontSize=45&fontColor=ffffff&animation=fadeIn&fontAlignY=35" />

# 👋 Hi, I'm nahyunni

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=23&pause=1000&color=36BCF7&center=true&vCenter=true&width=850&lines=Cloud+Infrastructure+Engineer;OpenStack+Private+Cloud+Operator;Backend+Developer+with+Infra+Mindset;Monitoring+%7C+Automation+%7C+Reliability;Always+learning+better+ways+to+operate+systems" alt="Typing SVG" />
...
```txt
클라우드 인프라와 백엔드 개발을 함께 다룹니다.
OpenStack 기반 프라이빗 클라우드, 모니터링, 자동화, 운영 안정성에 관심이 많습니다.

서비스가 단순히 동작하는 것에서 끝나는 것이 아니라,
장애 상황에서도 원인을 추적하고 다시 안정적으로 운영될 수 있는 구조를 고민합니다.
```
...
<img src="https://img.shields.io/badge/Cinder-ED1944?style=for-the-badge&logo=openstack&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Mimir-F46800?style=for-the-badge&logo=grafana&logoColor=white"/>
...
```txt
OpenStack   Linux   Docker   GitHub Actions   Spring Boot
FastAPI     PostgreSQL   Prometheus   Grafana   Ceph
```
